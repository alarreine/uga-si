...
void Viewer::createShaders() {
  ...
  _vertexFilenames.push_back("shaders/gouraud1.vert");
  _fragmentFilenames.push_back("shaders/gouraud1.frag");

  _vertexFilenames.push_back("shaders/gouraud2.vert");
  _fragmentFilenames.push_back("shaders/gouraud2.frag");

  _vertexFilenames.push_back("shaders/phong.vert");
  _fragmentFilenames.push_back("shaders/phong.frag");

  _vertexFilenames.push_back("shaders/toon.vert");
  _fragmentFilenames.push_back("shaders/toon.frag");
