...
void Viewer::createTextures() {
  ...
  // create first texture on the GPU
  ...
  // create second texture on the GPU
  glGenTextures(1,&_texIds[1]);
  image2 = QGLWidget::convertToGLFormat(QImage("textures/chesterfield-ao.png"));
...
// create second texture on the GPU
glGenTextures(2,&_texIds[2]);
image3 = QGLWidget::convertToGLFormat(QImage("textures/chesterfield-normal.png"));
...
// create second texture on the GPU
glGenTextures(3,&_texIds[3]);
image4 = QGLWidget::convertToGLFormat(QImage("textures/env1.jpg"));
...
void Viewer::createShaders() {
  ...
  // TODO: add your shaders here
          ...
          _vertexFilenames.push_back("shaders/env-mapping.vert");
          _fragmentFilenames.push_back("shaders/env-mapping.frag");
}
...
void Viewer::enableShader(unsigned int shader) {
  ...
  glBindTexture(GL_TEXTURE_2D,_texIds[1]);
  glUniform1i(glGetUniformLocation(id,"ambientmap"),1);
  ...
  glBindTexture(GL_TEXTURE_2D,_texIds[3]);
  glUniform1i(glGetUniformLocation(id,"envmap"),3);
